  ...
  return (
    <Routes>
      ...
      <Route element={<PortalLayout />}>
        ...
        <Route path="/app/perfil" element={<RequireBiker><PlaceholderPage title="Mi perfil" /></RequireBiker>} />
        ...
        <Route path="/studio/perfil" element={<RequireStudio><PlaceholderPage title="Perfil de estudio" /></RequireStudio>} />

        {/* Admin */}
        <Route path="/admin" element={<PlaceholderPage title="Admin" />} />
        <Route path="/admin/bug-reports" element={<PlaceholderPage title="Reportes de bugs" />} />
      </Route>
    </Routes>
  )
}
