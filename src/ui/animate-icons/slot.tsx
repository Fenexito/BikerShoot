...
// Portado a mano desde el registro de Animate UI — permite que `AnimateIcon`
// (ver `icon.tsx`) le pase sus handlers de hover/tap al elemento hijo real
// (`asChild`) en vez de envolverlo en un `<span>` extra. Sin cambios de
// lógica frente al original.
