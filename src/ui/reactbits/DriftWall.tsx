// Adaptado de reactbits.dev (DriftWall, variante JS-CSS) — lógica intacta,
// solo tipado a TS + un `onItemClick` opcional (el original solo soporta
// abrir un link externo por tile; lo necesitamos para abrir el lightbox
// propio del sitio con la foto en vez de navegar afuera).
