// Adaptado de reactbits.dev (ScrollExpand, variante JS-CSS) — sin cambios de
// lógica, solo tipado a TS. Los colores/tamaños se controlan por props desde
// donde se usa (ver StudioEventView.tsx) para respetar el sistema de diseño.
