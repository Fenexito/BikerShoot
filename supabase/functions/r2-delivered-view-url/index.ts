...
// fotógrafo vea/abra la entrega final (delivered_path) que él mismo subió
// para una foto vendida — así puede revisarla en alta calidad sin tener
// que buscar el archivo en su computadora. Solo el dueño de la foto puede
// pedirlo; el biker usa r2-download-url (gated por compra), no esta.
//
...
Deno.serve(async (req: Request) => {
  ...
  if (!photo.delivered_path) return json({ error: 'not_delivered', message: 'Esta foto todavía no tiene una entrega final subida' }, 409)
